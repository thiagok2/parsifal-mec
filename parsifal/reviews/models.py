...
class Review(models.Model):
    ...
    study_type = models.CharField(max_length=200, blank=True, null=True)
    pico_type = models.CharField(max_length=200, choices=PICO_TYPE, default=PICOC)
    pico_text = models.CharField(max_length=1000,  blank=True, null=True)
    ...
    statistical_methods=models.TextField(max_length=1000,blank=True, null=True)
