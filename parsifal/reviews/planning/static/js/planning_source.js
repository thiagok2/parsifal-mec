$(function () {
  ...
  function editSource() {
    if (!is_adding_or_editing_source) {
      ...
      str_row += '<td class="text-right"><button type="button" class="btn btn-success btn-sm btn-save-source"><span class="glyphicon glyphicon-ok"></span> salvar</button> <button type="button" class="btn btn-default btn-sm btn-cancel-source">cancelar</button></td>';
