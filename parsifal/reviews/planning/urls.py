...
urlpatterns = patterns('parsifal.reviews.planning.views',
    ...
    url(r'^get_articles_source/$', 'get_articles_source', name='get_articles_source'),
    ...
    url(r'^edit_quality_assessment_answer2/$', 'edit_quality_assessment_answer2', name='edit_quality_assessment_answer2'),
