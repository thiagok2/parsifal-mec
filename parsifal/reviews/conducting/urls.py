...
urlpatterns = patterns('parsifal.reviews.conducting.views',
    ...
    url(r'^save_article_evaluation/$', 'save_article_evaluation', name='save_article_evaluation'),
    url(r'^article_solve_conflict/$', 'article_solve_conflict', name='article_solve_conflict'),
