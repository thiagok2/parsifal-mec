...
urlpatterns = patterns('parsifal.reviews.conducting.views',
    ...
    url(r'^article_details_confirm/$', 'article_details_confirm', name='article_details_confirm'),
    ...
    url(r'^save_article_details_confirm/$', 'save_article_details_confirm', name='save_article_details_confirm'),
